...
function module:Update_Character(dt) -- This is a simple method, you can use to modify self
    ...
    Character.Velocity = (Character.Velocity + MoveVector:getUnit() * dt * Character.Speed) / (1 + dt*5) -- 1.1 is the damping vector, Make the character move smootly
...
function module:Setup() 
    ...
    local pos = 0.2
    for i,v in pairs(PossibleColors) do
    ...
    self.PlayerCharacter = Spritesheet(self.Directory .. "/assets/creature-sheet.png", Vector2(24, 24), .35)
...
function module:Start()
    ...
    -- Play dah music
    self.PlayMusic(self.Directory .. "/assets/music.mp3")
end
